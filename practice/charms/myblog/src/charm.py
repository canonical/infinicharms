...
class MyblogCharm(ops.CharmBase):
    """Myblog charm — a simple web server."""
    ...
    def __init__(self, framework: ops.Framework):
        ...
        framework.observe(self.on.webserver.pebble_ready, self._on_config_changed)
...
__all__ = ["MyblogCharm", "NotImplementedFeature", "main"]
